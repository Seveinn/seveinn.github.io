...
tags:
  []
excerpt: "面试题 v show和v if的区别 v for中为何要用key Vue组件生命周期（有父子组件的情况） 组件通讯 组件的渲染和更新过程 双向数据绑定 v model的实现原理 Vue3 Vue3 Options API React class component Vue3 Composition API React…"
status: published
legacyUrl: /posts/2021/03/23/vue-note.html
---
# 面试题
#### v-show和v-if的区别
```
