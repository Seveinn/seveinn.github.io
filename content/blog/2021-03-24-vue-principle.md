...
title: "Vue 原理"
slug: vue-principle
publishDate: "2021-03-24T14:07:24+08:00"
updatedDate: "2021-03-24T14:07:24+08:00"
author: Seveinn
categories:
  - 前端
  - 面试
...
tags:
  []
excerpt: "组件化 组件化基础 “很久以前”的组件化 asp jsp php nodejs 数据驱动视图（框架本身实现了从数据到DOM的渲染，我们只需关注数据和业务逻辑） 传统组件，只是静态渲染，更新依赖于操作DOM（ 催生了JQuery, 方便DOM操作） 数据驱动视图 —— React setState 数据驱动试图 —— V…"
status: published
legacyUrl: /posts/2021/03/24/vue-principle.html
---
## 组件化
组件化基础
“很久以前”的组件化
...
![vue渲染更新全流程](/blog-assets/vue-principle/vue-render-flow.jpg)

<img src="/blog-assets/vue-principle/vue-render-flow.jpg" alt="vue渲染更新全流程" title="vue渲染更新全流程">
